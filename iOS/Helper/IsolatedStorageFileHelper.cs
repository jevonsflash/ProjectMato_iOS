...
using FileAccess = XLabs.Platform.Services.IO.FileAccess;
using FileMode = XLabs.Platform.Services.IO.FileMode;
using FileShare = XLabs.Platform.Services.IO.FileShare;
...
namespace ProjectMato.iOS.Helper
{
    ...
    public class IsolatedStorageFileHelper : IFileManager
    {
        /// <summary>
        ...
        /// </summary>
        public IsolatedStorageFileHelper() : this(IsolatedStorageFile.GetUserStoreForApplication())
        {
        ...
        public IsolatedStorageFileHelper(IsolatedStorageFile isolatedStorageFile)
        {
        ...
        {
            return this.isolatedStorageFile.CreateFile(path);
        }
